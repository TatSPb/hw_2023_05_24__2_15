package hw_2023_05_24__2_15;

import java.util.Arrays;
import java.util.Random;

public class hw_2023_05_24__2_15_main {
    public static void main(String[] args) {

        int[] initialArray = generateArray(10_000);

        long timeForBubbleSorting = calculateTime(
                10, () -> sortBubble(Arrays.copyOf(initialArray, initialArray.length)));
        long timeForSelectionSorting = calculateTime(
                10, () -> sortSelection(Arrays.copyOf(initialArray, initialArray.length)));
        long timeForInsertionSorting = calculateTime(
                10, () -> sortInsertion(Arrays.copyOf(initialArray, initialArray.length)));
